...
def print_banner():
    print("""
~X~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~[
~U                    SELF-HEALING OPS v2.0                                ~U
~U              Intelligent AIOps Self-Healing System                      ~U
~d~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~g
~U                                                                        ~U
...
~U                                                                        ~U
~U   Pipeline:      [Monitor] -u [Diagnostic] -u [Repair] -u [Verify]       ~U
...
~U                                                                        ~U
~^~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~a
""")
...
def print_scenarios():
    ...
    print("~d~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~g")
    for key, (scenario, desc) in SCENARIOS.items():
        print(f"~U  {key}. {desc:55s} ~U")
    print("~^~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~T~a")
